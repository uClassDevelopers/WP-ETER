...
<script type="text/javascript">
    ...
    $(function(){
        ...
        if(this.checked) {
            $("#fr_wrapper").toggle();
            $("#f_row").append('<input name="dyn_link_fr" id="dyn_link_fr" type="text" placeholder="Skriv in länk">');
        } else {
            $("#fr_wrapper").toggle();
            $("#dyn_link_fr").remove();
        }
    ...
    $(function(){
        ...
        if(this.checked) {
            $("#sr_wrapper").toggle();
            $("#s_row").append('<input name="dyn_link_sr" id="dyn_link_sr" type="text" placeholder="Skriv in länk">');
        } else {
            $("#sr_wrapper").toggle();
            $("#dyn_link_sr").remove();
        }
