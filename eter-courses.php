    ...
    function get_courses(){
        $.ajax({ 
            ...
            success: function (data) { 
                $('.course-selector option:selected').each( function(index){
                ...
                $.each(data.list_courses, function(index, element) {
                    ...
                    values = [];
                    name = element.name;
                    values = $('.course-selector option:selected').text();
                    console.log(values);
                    if ( values === name ) {
                        console.log('-');
                    } else {
            ...
            <div id="top_images">
                <div id="top_images_container">
                    ...
                    <div class="border-btm">
                        ...
                        <div><h3 id="course-selector">Välj en kurs:
                            <select name="course[]" class="course-selector">
                                <option selected><?php echo $course ?></option>
                            </select>
                            Vald kurs: <input type="text"  disabled value="<?php echo $course; ?>"/>
                            </h3>
